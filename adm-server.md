...
## DIR UPLOADS
It contains 3 files:
1. mime.jpg: I tried steghide but a passphrase is neccessary
2. manifesto.txt: nothing interesting on it
3. dict.lst: it seems a wordlist
...
I attempt JtR with that previously tacked with ssh2john an obtein a password: letmein
